...
class driverMonitoring extends StatefulWidget {

  @override
  _driverMonitoring createState() => _driverMonitoring();
}

class _driverMonitoring extends State<driverMonitoring> {
  bool start = false;
